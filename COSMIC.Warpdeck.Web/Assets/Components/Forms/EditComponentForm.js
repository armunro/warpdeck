export default {
    props: {
        componentmodel: Object, keyproperties: Object, iconproperties: Object, triggers: Object
    ...
    <form class="form">
      <div id="propertiesCard" class="active" v-if="componentmodel !== null">
        <div class="card mb-2">
          ...
          " class="form-group">
                  <div class="input-group mb-2" v-if="componentmodel.Actions[trigger.actionName]"><span
                      class="input-group-text">{{ trigger.actionName }}
                    Action</span><select
                    ...
                    <div>
                      <div class="form-group"
                           v-for="(param, index) in componentmodel.Actions[trigger.actionName].Parameters">
